...
class JPHassWebsocketEndpoint: AbstractJavaProperty<String>(COMMAND_IDENTIFIERS) {
    ...
    companion object {
        ...
        private val COMMAND_IDENTIFIERS = arrayOf("--homeassistant-ws-endpoint", "--hass-ws")

        private const val DEFAULT_HOST = "/api/websocket"
    }
}
